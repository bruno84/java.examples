 ...
 * Observacao: implementacao com generic e com gerenciador de ID.
 * @author Bruno Monteiro
 */
public class MyLinkedListSinglyV2comID <T> implements MyInterfaceListV2comID <T>
{
	// Classe Interna Node
	class Node
	{
	...
	public MyLinkedListSinglyV2comID() {
		head = null;
		tail = null;
		nextId = 1;
		size = 0;
