...
/**
 * Objetivo: Lista simplesmente encadeada, com generic, e simulando sequence ID.
 * @author Bruno Monteiro
 */
public class MyLinkedListDoubleV2comID <T> implements MyInterfaceListV2comID <T>
{
	// Classe Interna Node
	class Node
	{
	...
	public MyLinkedListDoubleV2comID() {
		head = null;
		tail = null;
		nextId = 1;
		size = 0;
